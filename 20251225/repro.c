...
void execute_one(void)
{
  ...
  //          array[ANYUNION] {
  //            union ANYUNION {
  //              ANYBLOB: buffer: {18 02 00 00 23 43 ff ff 00 00 00 00 00 00 00
  //              00 85 00 00 00 41 00 00 00 95} (length 0x19)
  //            }
  //          }
  //        }
  ...
  //        flags: bpf_prog_load_flags = 0x64 (4 bytes)
  ...
  *(uint32_t*)0x2000000000d0 = 0;
  ...
  //        flags: xdp_flags = 0x2 (4 bytes)
  //        extra: union optional[link_create_arg_extra] {
  //          val: union link_create_arg_extra {
  //            netkit: link_create_netkit {
  //              relative_link_fd: union
  //              _link_create_netkit_relative_link_fd_wrapper {
  //                void: buffer: {} (length 0x0)
  //              }
  //              relative_prog_fd: union
  //              _link_create_netkit_relative_prog_fd_wrapper {
  //                value: fd_bpf_prog (resource)
  //              }
  //              relative_link_id: union
  //              _link_create_netkit_relative_link_id_wrapper {
  //                void: buffer: {} (length 0x0)
  //              }
  //              relative_prog_id: union
  //              _link_create_netkit_relative_prog_id_wrapper {
  //                void: buffer: {} (length 0x0)
  //              }
  ...
  //      }
  //    }
  //    size: len = 0x1c (8 bytes)
  //  ]
  //  returns fd_bpf_link
  *(uint32_t*)0x200000001580 = r[1];
  *(uint32_t*)0x200000001584 = r[2];
  *(uint32_t*)0x200000001588 = 0x25;
  *(uint32_t*)0x20000000158c = 2;
  *(uint32_t*)0x200000001590 = -1;
  *(uint64_t*)0x200000001594 = 0;
  syscall(__NR_bpf, /*cmd=*/0x1cul, /*arg=*/0x200000001580ul, /*size=*/0x1cul);
  //  syz_emit_ethernet arguments: [
  //    len: len = 0x11dc0 (8 bytes)
  ...
  //    frags: nil
  //  ]
  syz_emit_ethernet(/*len=*/0x11dc0, /*packet=*/0x200000000740, /*frags=*/0);
}
int main(void)
{
